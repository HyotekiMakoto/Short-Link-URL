...
const Navbar: React.FC<NavbarProps> = ({ user, setUser }) => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-50 transition-colors duration-200">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
            ...
            <div className="relative" ref={settingsRef}>
              <button 
                ...
                className="p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 focus:outline-none transition-colors group"
                title={t('nav.settings')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform transition-transform duration-500 group-hover:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {isSettingsOpen && (
                <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 focus:outline-none animate-fade-in-down z-50">
                  <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-600">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-200">{t('nav.settings')}</p>
                  </div>
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                <span className="text-sm text-gray-700 dark:text-gray-300">{t('nav.hello')}, <strong>{user.name}</strong></span>
                <button
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 transition-transform duration-300 active:scale-95"
            >
      ...
      <div className={`${isOpen ? 'block animate-fade-in-down' : 'hidden'} sm:hidden bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 transition-colors duration-200 origin-top`}>
        ...
        <div className="pt-4 pb-4 border-t border-gray-200 dark:border-gray-700">
           ...
           >
             ...
             {t('nav.language')}: <span className="ml-2 uppercase font-bold text-indigo-600 dark:text-indigo-400">{language === 'vi' ? 'Tiếng Việt' : 'English'}</span>
           </button>
        </div>
