              ...
              <div className="mt-2">
                ...
                {!result ? (
                  ...
                  <div className="rounded-md bg-gray-50 p-4">
                    <div className="flex">
                      <div className="ml-3">
                        <h3 className="text-sm font-medium text-gray-800">Kết quả xử lý</h3>
                        <div className="mt-2 text-sm text-gray-700">
                          <p className="text-green-600">✓ Thành công: {result.success}</p>
                          {result.errors.length > 0 && (
                            <div className="mt-2">
                                <p className="text-red-600 font-medium">⚠ Lỗi ({result.errors.length}):</p>
                                <ul className="list-disc list-inside text-red-500 text-xs mt-1 max-h-32 overflow-y-auto">
